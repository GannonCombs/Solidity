//This smart contract accepts a flash loan from Uniswap, and performs arbitrage on an asset between Uniswap and Sushiswap exchanges.
...
contract UniswapArbitrage {
    ...
    function uniswapV2Call(address _sender, uint _amount0, uint _amount1, bytes calldata _datas) external {
